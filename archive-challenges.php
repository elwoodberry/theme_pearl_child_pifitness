  ...
  <div class="container">
    <div class="stm_flex stm_flex_last stm_flex_center">
      <div class="stm_titlebox__inner">
          ...
          <h1 class="h1 stm_titlebox__title no_line text-transform stm_mgb_2">You can feel sore tomorrow or</h1>
          <div class="stm_titlebox__subtitle">You can feel sorry tomorrow. Your Choice.</div>
      </div>
    </div>
  </div>
</div>
