<?php
  ...
  // PIFITNESS
  // Child Theme of 'PEARL'

  // IMAGE.PHP
  // 'partials/header/elements/image/image.php'
...
<?php elseif(!empty($image_id)):
	...
	<a class="h3 stm_mgb_0 text-transform no_deco no_line" href="<?php echo esc_url($url); ?>">
		<img width="135" height="72" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/img/pifitness_logo_' . $logo . '.svg') ?>" alt="">
	</a>
